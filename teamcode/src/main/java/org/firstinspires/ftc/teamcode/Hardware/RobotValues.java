...
public class RobotValues {
    ...
    public static double foundationletgo = 0.8;
    public static double foundationReady = 0.4;

    public static double foundationGrab = .1;
    ...
    public static int fourincheslift = 150;
