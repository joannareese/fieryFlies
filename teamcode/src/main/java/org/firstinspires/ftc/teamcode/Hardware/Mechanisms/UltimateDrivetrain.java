...
import static org.firstinspires.ftc.teamcode.Hardware.DriveConstants.FAST_CONSTRAINTS;
import static org.firstinspires.ftc.teamcode.Hardware.DriveConstants.SLOW_CONSTRAINTS;
...
public abstract class UltimateDrivetrain extends MecanumDrive {
    ...
    private SampleMecanumDriveBase.Mode mode;
    ...
    public UltimateDrivetrain() {
        super(kV, kA, kStatic, TRACK_WIDTH);

        dashboard = FtcDashboard.getInstance();
        clock = NanoClock.system();

        mode = SampleMecanumDriveBase.Mode.IDLE;
        ...
        follower = new HolonomicPIDVAFollower(TRANSLATIONAL_PID, TRANSLATIONAL_PID, HEADING_PID,new Pose2d(40,40,Math.toRadians(8)),.3);
    ...
    public void turn(double angle) {
        ...
        mode = SampleMecanumDriveBase.Mode.TURN;
    }
    ...
    public void followTrajectory(Trajectory trajectory) {
        ...
        mode = SampleMecanumDriveBase.Mode.FOLLOW_TRAJECTORY;
    }
    ...
    public boolean isBusy() {
        return mode != SampleMecanumDriveBase.Mode.IDLE;
    }
